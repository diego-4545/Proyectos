...
<h2 class="title">Bienvenido de nuevo <?php echo isset($_SESSION['nombre']) ? $_SESSION['nombre'] : 'Usuario'; ?></h2>
...
<div class="container is-fluid" style="margin-top: 20px;">
  ...
  <div class="is-flex is-align-items-center" style="gap: 10px; margin-top: 10px;">
    ...
    <a href="http://localhost/RADCS/index.php?vista=cita_cliente" class="button is-success">Agregar Cita</a>
    <!-- Barra de búsqueda -->
    <form action="index.php?vista=home_cliente" method="GET" class="is-flex" style="flex-grow: 1;">
      <input type="hidden" name="vista" value="home_cliente">
    ...
    <!-- Botón de regresar -->
    <a href="http://localhost/RADCS/index.php?vista=home_cliente" class="button is-warning">Regresar</a>
...
<div class="container pb-6 pt-6">
    <?php
        ...
        $url = "index.php?vista=home_cliente&page=";
        $registros = 10;
        $busqueda = isset($_GET['busqueda']) ? limpiar_cadena($_GET['busqueda']) : "";

        # Paginador usuario #
        require_once "PHP/cita_lista_cliente.php";
    ?>
</div>
