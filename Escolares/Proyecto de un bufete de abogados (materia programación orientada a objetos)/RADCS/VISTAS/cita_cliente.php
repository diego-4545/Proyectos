            ...
            <?php
                ...
                if ($especialidades->rowCount() > 0) {
                    ...
                    foreach ($especialidades as $row) {
                        echo '<a href="index.php?vista=cita_cliente&especialidad_id=' . $row['Id_esp'] . '" class="button is-link is-light is-fullwidth mb-2">' . $row['No_esp'] . '</a>';
                    }
                } else {
    ...
    <div class="modal-card">
        ...
        <section class="modal-card-body">
            ...
            <form action="PHP/cita_guardar.php" method="POST" class="FormularioAjax" autocomplete="off">
                ...
                <input type="hidden" name="Id_cli" value="<?php echo $id_cliente; ?>">
